...
function Bannerdown() {
  ...
  <div className="absolute  transform left-32 mt-40 text-white ">
    <h1 className="text-3xl font-bold">Step Up Your Style Game <br/> with Crocksi Fashion <br/>House Customized Shoes</h1>
    <p className="mt-4 text-sm">Make a Statement with Your Feet – Crocksi Custom Shoes, Personalized Just for You</p>
    <button className="mt-8 bg-red-700 text-white py-2 px-4 rounded-lg hover:bg-gray-300 hover:text-gray-900 transition duration-200 ease-in-out">Get Started</button>
  </div>
</div>
   </>
  )
